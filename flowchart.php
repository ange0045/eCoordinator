...
<h3 class='lbl_user'><button data-toggle='modal' data-target='#view-modal-info' id='btnOpenFlowchartInfo' class="info"><div class="info"><i class="fa fa-info-circle"></i></div></button> Student: <?php echo $stuObj->getName()."(".$stuObj->getStudentId().")"; ?><a href='/eCoordinator/index.php'><div class="flo-close"><i class="fa fa-window-close"></i></div></a></h3>
<div class="style"></div>
