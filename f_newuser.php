...
if(isset($btnLogin)){
    ...
    $sVal_AccessType    = val_NewUser('Access Type', 'fldAccessType');
    ...
    if(empty($_SESSION['errCheck'])){ // No errors found, adds user to db
        ...
        $_SESSION['ses_fldAccessType'] = "";
        $_SESSION['ses_fldPassword'] = "";
        $_SESSION['ses_fldConfPassword'] = "";
        $dao->addNewUser($fldUsername, $fldFullName, $fldAccessType, md5($fldPassword)); // Adds new user to database
    ...
    <form id="form_new_user" method="post">
        <div class="login-cont offset-sm-3 col-sm-6">
            ...
            <?php
              ...
              $val_AccessType = ['Admin', 'Editor', 'Reader'];
              func_fieldBuilder("SELECTFIELD", "Access Type", "fldAccessType", "" , $fldAccessType, "typeDrpDwn", "", "col-sm-4", "col-sm-4", "", "", $val_AccessType, $sVal_AccessType);
